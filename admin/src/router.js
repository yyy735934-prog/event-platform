...
const routes = [
  ...
  { path: '/admin/events/new', component: () => import('./views/host/EventForm.vue'), meta: { reviewer: true } },
  { path: '/admin/events/:id', component: () => import('./views/host/EventDetail.vue') },
  { path: '/admin/events/:id/edit', component: () => import('./views/host/EventForm.vue'), meta: { reviewer: true } },
  ...
  { path: '/admin/gathering-templates', component: () => import('./views/reviewer/GatheringTemplates.vue'), meta: { reviewer: true } },
  { path: '/admin/gatherings/:id', component: () => import('./views/host/GatheringManage.vue'), meta: { host: true } },
